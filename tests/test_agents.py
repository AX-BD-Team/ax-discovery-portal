...
def sample_signal():
    ...
    return {
        ...
        "evidence": [
            {"type": "meeting_note", "title": "ABC금융 미팅", "url": "https://..."}
        ],
        "status": "NEW",
        "owner": "홍길동",
        "confidence": 0.8,
...
class TestBriefWriter:
    ...
    def test_brief_required_fields(self):
        """Brief 필수 필드 테스트"""
        required_fields = [
            "brief_id", "signal_id", "title", "customer",
            "problem", "solution_hypothesis", "kpis",
            "evidence", "validation_plan", "owner", "created_at"
        ]
